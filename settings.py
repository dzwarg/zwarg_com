...
COMPRESS_STORAGE = STATICFILES_STORAGE = 's3utils.StaticS3BotoStorage'
...
COMPRESS_ROOT = STATIC_ROOT = os.path.join(PROJECT_ROOT, STATIC_URL.strip("/"))
...
#     "LOCALE": "en_US.UTF-8", # Should end with ".UTF-8"
     "LIVE_HOSTNAMES": ["zwarg.com", "www.zwarg.com"], # Host for public site.
