...
env.db_pass = conf.get("DB_PASS", os.environ.get("DB_PASS", None))
...
env.admin_pass = conf.get("ADMIN_PASS", os.environ.get("ADMIN_PASS", None))
env.user = conf.get("SSH_USER", os.environ.get("SSH_USER", getuser()))
env.key_filename = conf.get("SSH_KEY_PATH", os.environ.get("SSH_KEY_PATH", None))
